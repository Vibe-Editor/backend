...
export class SummariesService {
   ...
   */
  async generateSummary(dto: GenerateSummaryDto, userId: string): Promise<string> {
    const { content, contentType, projectId } = dto;
   ...
   */
  async createSummary(dto: CreateSummaryDto, userId: string) {
